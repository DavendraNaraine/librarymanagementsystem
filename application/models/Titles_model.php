...
class Titles_model extends CI_Model{
    ...
    function addTitle($title){
        ...
        $this->db->set('title_name', $title->title_name);
        $this->db->set('title_author', $title->title_author);
        $this->db->set('title_coauthor', $title->title_coauthor);
        $this->db->set('title_edition', $title->title_edition);
        $this->db->set('title_publisher', $title->title_publisher);
        $this->db->set('title_isbn', $title->title_isbn);
        $this->db->insert('titles');
        $insert_id = $this->db->insert_id();

        $this->db->set('title_id', $insert_id);
        $this->db->set('subject_id', $title->subject_id);
        $this->db->insert('title_subjects');

        //$r = $this->db->insert('subjects', $subject);
        return "Title Added";
        //     $data = array(
